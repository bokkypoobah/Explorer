...
app.component("portfolioRenderCollection", PortfolioRenderCollection);
app.component("portfolioRenderBalance", PortfolioRenderBalance);
app.component("portfolioRenderToken", PortfolioRenderToken);
