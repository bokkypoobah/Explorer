  ...
  template: `
    <div>
      <v-container fluid class="pa-1">
        ...
        <v-tabs-window v-if="false" v-model="settings.tab">
                ...
                <v-row no-gutters dense>
                  ...
                  <v-col cols="6" align="left">
                    <v-btn variant="text" class="lowercase-btn ma-0 px-2" style="min-width: 0px;">
                      {{ numberOfEvents != null && commify0(numberOfEvents) || "Click [Sync Portfolio Events] above" }}
                    </v-btn>
                  </v-col>
                </v-row>
              </v-card-text>
...
nftOwnersList: {{ nftOwnersList }}
  ...
  mounted() {
    console.log(now() + " Portfolio - mounted - inputAddress: " + this.inputAddress);
